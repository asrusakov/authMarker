...
namespace pex_key {
    ...
    //@brief https://thealgorithms.github.io/C-Plus-Plus/index.html
    namespace hashing {
        namespace sha256 {
            class Hash {
    ...
    static char key_hash[] = "8670b05424b110fd0e98360ddc2472ecd8d7e21cba1ed4fe91ef96a4d8ce085e";
    bool is_valid_key(const std::string& key) {
        static std::string expected = "1111";
        const auto hash_of_this_key = hashing::sha256::sha256(key);
        const bool valid (hash_of_this_key == key_hash);
        return valid;
    }
}//pex